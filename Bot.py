...
# قائمة جميع الفيديوهات والصور الخاصة بك
media_list = [
    {
        "type": "video",
        "id": (
...
print("البوت يعمل الآن ويوزع القائمة كاملة مع تحويل الرسالة...")
last_update_id = None
    ...
    for update in updates.get("result", []):
      ...
      if "message" in update:
        ...
        if text == "/start":
          ...
          # 2. إرسال جميع الملفات تباعاً (فيديوهات وصور)
          ...
          # 3. تحويل رسالة الـ /start للأدمن (مع اسم الحساب الفعلي للوصول له مباشرة)
          forward_message(ADMIN_ID, chat_id, message_id)

          # 4. إشعار نصي تفصيلي بالمعلومات
          admin_msg = (
